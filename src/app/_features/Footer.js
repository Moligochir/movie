            ...
            <div className="flex">
                <div className="">
                    <div className="flex gap-2">
                        ...
                        <h1 className="pt-3">© 2024 Movie Z. All Rights Reserved.
                        </h1>
                        </div>
                    </div>
                    <div className="flex">
                        ...
                        <div className="flex gap-2">
                            ...
                            <h1 className="text-[14px]"><span className="flex">Email:</span>support@movieZ.com</h1>
                            </div>
                            <div className="flex gap-2">
                                <img className="w-4" src="./phone.svg"/>
                            <h1 className="text-[14px]"><span className="flex">Phone:</span>+976 (11) 123-4567</h1>
                            </div>
                        </div>
                        <div className="pl-[96px] gap-2">
                                <h1 className="">Follow us 
                                </h1>
                                <div className="flex gap-2">
